                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="caption">
                            ...
                            <p>Lombok Vibes is a reliable car rental service provider in Lombok, offering a wide range of
                                vehicle options from city cars to family cars. The company also provides various tour
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-service-item owl-carousel">
                        ...
                        <a href="detail_wisata.html" class="item"
                                            ...
                                            <div
                                                ...
                                                <div class="modal-content shadow-lg border-0">
                                                    <div class="modal-header bg-primary text-white">
                                                        <h5 class="modal-title fw-bold" id="detailModalLabel">Detail Paket
                                                        </h5>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        ...
                        <p>
                            Providing service with a swift response, seamless experience, and a diverse fleet of vehicles
                            available for self-drive or with a professional driver. Your satisfaction is our top priority.
                        </p>
                    </div>
                </div>
                <div class="col-lg-12">
